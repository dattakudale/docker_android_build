...
ENV ANDROID_COMPONENTS platform-tools,android-28,build-tools-28.0.3
...
ENV PATH $PATH:$ANDROID_SDK_HOME/build-tools/28.0.3


#COPY Linceses
RUN mkdir -p /usr/local/android-sdk/licenses
COPY licenses /usr/local/android-sdk/licenses/
